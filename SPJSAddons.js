...
spjs.rm = {
    ...
    "init": function (c) {
        ...
        if (spjs.rm.data.args !== undefined && spjs.rm.data.args.resourceField !== "" && spjs.rm.data.args.dateFrom !== "" && spjs.rm.data.args.dateTo !== "") {
            ...
            PreSaveAction = function () {
                ...
                var b, res, rVal, selectedHour_start, selectedHour_end, selectedMinute_end, bSetting, dateRange_start, dateRange_end, dateRange_start_friendlyName, dateRange_end_friendlyName, dateMinControl, dateMaxControl, dayByDayObj, bookableDateRangesFriendly, dTemp, inDateRange, inTimeRange, vDate;
                    ...
                    if (res.isOverlap) {
                        ...
                        if (spjs.rm.data.args.bookableTimeRangeActive) {
                            ...
                            bSetting = spjs_QueryItems({
                                ...
                                "viewFields": ["From_0", "To_0", "From_1", "To_1", "From_2", "To_2", "From_3", "To_3", "From_4", "To_4", "From_5", "To_5", "From_6", "To_6", "FromDate", "ToDate"]
                            });
                            if (bSetting.count > 0) {
                                dayByDayObj = {};
    ...
    "checkDateOverlap": function (a, b) {
        ...
        c.push("</And>");
        c.push("<Eq>");
        c.push("<FieldRef Name='" + spjs.rm.data.args.resourceField + "' /><Value Type='Text'>" + getFieldValue(spjs.rm.data.args.resourceField) + "</Value>");
        c.push("</Eq>");
        c.push("</And>");
